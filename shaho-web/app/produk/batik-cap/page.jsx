            ...
            <div className="max-w-full lg:w-2/3">
              ...
              <div className="w-auto sm:w-[30rem] md:w-[35rem] lg:w-auto h-auto p-3">
                <h1 className="text-center lg:text-start font-poppins text-blue-main text-md sm:text-lg xl:text-xl">
                  Batik Printing adalah batik yang dibuat dengan cara
                  menge-print desain atau motif yang sudah dibuat di atas kain.
                  Batik Printing ini biasa digunakan untuk membuat seragam atau
                  pesanan dalam partai besar. Pembuatan Batik Printing relatif
                  lebih cepat daripada Batik Tulis, Batik Cap, maupun Batik
                  Kombinasi.
                </h1>
              </div>
