      ...
      <div className="relative w-full h-auto md:h-auto pt-20 md:pt-28 flex justify-center items-center">
        <div className="w-[80%] lg:w-[90%] h-[85%] lg:h-[90%] flex flex-col lg:flex-row justify-center items-center">
          ...
          <div className="w-full h-1/2 md:h-1/3 lg:h-full flex flex-col justify-evenly items-center">
            ...
            <div className="w-full flex justify-center py-2 lg:justify-start lg:pl-10">
              <Image
                src={Tagline}
                alt="Tagline"
            ...
            <div className="flex w-full py-2 gap-5 justify-center items-center lg:justify-start lg:pl-10">
              ...
              <Link href="/produk">
                <div className="hidden lg:flex w-[calc(12rem+2vw)] h-9 lg:h-[calc(2.25rem+.5vw)] rounded-md bg-blue-main justify-center items-center hover:opacity-60 hover:scale-105 duration-200 shadow-gray-500 shadow-md">
                  <h1 className="text-white-main font-poppins text-[.8rem] lg:text-[calc(.8rem+.2vw)] font-semibold tracking-wider">
                    Produk dan Layanan
                  </h1>
                </div>
