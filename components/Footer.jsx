...
import mapsButton from "@/public/icons/maps-button.svg";
      ...
      <div className="relative w-full h-auto lg:h-[25vw] lg:max-h-[25rem] flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="w-full h-auto lg:w-1/4 lg:pt-12 lg:px-3 lg:h-full flex justify-center">
          ...
          <div className="w-[65vw] pb-5 h-full">
            ...
            <div className="flex items-center my-2 gap-3">
              <Link
                href={`https://goo.gl/maps/XqHw4WXMztcsZty89`}
                target="_blank"
              >
                <h1 className="font-poppins text-blue-main text-sm md:text-[1rem] hover:underline">
        ...
        <div className="w-full h-auto lg:w-1/4 lg:pt-12 lg:px-3 lg:h-full flex justify-center">
          ...
          <div className="w-[65vw] h-full pb-5">
            ...
            {/* Email */}
            <div className="flex items-center my-2 gap-3">
              <Link href={`mailto:batikshaho@gmail.com`} target="_blank">
                <Image
                  src={logoEmail}
                  width={30}
                  height={30}
        ...
        <div className="w-full h-auto pb-14 lg:pb-0 lg:pt-12 lg:px-3 lg:w-1/4 lg:h-full flex justify-center">
          ...
          <div className="w-[65vw] h-full">
            ...
            <div className="flex items-center my-2 gap-3">
              <Link
                href={`https://www.instagram.com/batik_shahokaltim/`}
                target="_blank"
              >
                <Image
                  src={logoInstagram}
